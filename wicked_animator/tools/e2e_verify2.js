...
const OUT = path.join(ROOT, 'cache', 'fixwave', 'verify2', 'e2e');
...
(async () => {
  ...
  await step(16, 'two animations with the same name', async () => {
    ...
    const backup = path.join(process.env.ANIMATOR_SAVES || path.join(DOCS, 'Electronic Arts', 'The Sims 4', 'saves', 'FitStudio'), 'animator_replaced');
