// Entry points for the Game Doctor and "Did it play in the game?" (R1-E): a Home card, two palette commands, a help
// row, the line under every Send-to-game result (wa:sent), and one quiet look at WickedWhims' log when the window
// comes back after a send. Everything registers through app.hooks (plan 2.4), so main.js, index.html and app.css
// stay untouched.
...
export function install(app) {
  ...
  window.wickedDoctor = { open: () => openDoctor(app), didItPlay: opts => openDidItPlay(app, opts) };
}
