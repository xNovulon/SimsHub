...
export function openHelp(app = window.app) {
  ...
  modal({
    ...
    body: h('div', {},
      ...
      h('div', { class: 'help-grid' },
        row(k('R'), 'Pose tool: click a part, turn the rings'), row(k('G'), 'Drag tool: pull hands, feet, hips'),
        row(k('M'), 'Place tool: move / turn a whole sim'), row(k('T'), 'Place: switch move / turn'),
...
const TOUR = [
  ...
  { sel: '#tool-seg', title: 'Three tools', text: 'Pose: click a body part and turn it. Drag: pull hands, feet and hips - the arms and legs follow. Place: move a whole sim. Hovering a part makes it glow.', side: 'bottom' },
