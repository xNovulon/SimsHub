...
export async function showHome(app) {
  ...
  const inner = h('div', { class: 'home-inner' },
    ...
    h('p', { class: 'home-gh' }, h('b', {}, 'Want to look at the project? '), 'Wicked Animator and Sims Hub are open source. ',
      h('a', { href: 'https://github.com/xNovulon/SimsHub', target: '_blank', rel: 'noopener' }, 'View them on GitHub'), '.'));
  root.append(inner);
